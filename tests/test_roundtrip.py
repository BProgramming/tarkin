...
def test_minimal_project_roundtrips():
...
def test_cross_schema_project_roundtrips():
...
def test_clearance_project_roundtrips():
...
def test_roundtripped_project_passes_validation():
