...
def make_role(name: str = "reader", schema: str = "public", can_login: bool = True, **kwargs) -> RoleConfig:
...
def build_cross_schema_project() -> GovernanceProject:
    ...
    role          = RoleConfig(
        ...
        can_login = True,
        on        = [
            SchemaPermissionConfig(name   ="public",
                                   usage  = True,
                                   tables = [TablePermissionConfig(name="users", select=True)],
                                   ),
            SchemaPermissionConfig(name = "sales",
                                   usage = True,
                                   ),
        ],
    )
